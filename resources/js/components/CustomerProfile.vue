                        ...
                        <div class="row align-items-end">
                            <div class="col-lg-8">
                                <div class="page-header-title">
                                    <div class="d-inline">
                                        <h4>CreateProfile For Customer</h4>
                                            ...
                                            <div class="col-md-12">
                                                <div class="media-left">
                                                    <a href="#" class="profile-image">
                                                        <img class="user-img img-radius" :src="getProfilePhoto()" alt="user-img">
<!--                                                        <img class="user-img img-radius" src="local_agent\files\assets\images\user-profile\user-img.jpg" alt="user-img">-->
                                    ...
                                    <div class="tab-pane active" id="personal" role="tabpanel">
                                        ...
                                        <div class="card">
                                            <div class="card-header">
                                                ...
                                                <button @click="newModal" id="edit-btn" type="button" class="btn btn-sm btn-primary waves-effect waves-light f-left">
                                                    Create Your Profile
                                                </button>
                                            </div>
...
export default {
    ...
    methods: {
        ...
        loadUsers(){
            ...
            axios.get("customer").then(({ data }) => (this.users = data));
        },
        updateProfile(e){
        ...
        createUser(){
            //made post request
            this.form.post('customer').then(response=>{
