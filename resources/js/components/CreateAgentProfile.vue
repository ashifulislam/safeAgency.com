...
<!--                                                        &lt;!&ndash;                                                        <img class="user-img img-radius" src="local_agent\files\assets\images\user-profile\user-img.jpg" alt="user-img">&ndash;&gt;-->
...
export default {
    ...
    methods: {
        ...
        loadUsers(){
            ...
            axios.get("agents").then(({ data }) => (this.users = data));
        },
        updateProfile(e){
        ...
        createUser(){
            //made post request
            this.form.post('agents').then(response=>{
