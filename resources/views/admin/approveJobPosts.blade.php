        ...
        <div class="product-status mg-b-30">
            <div class="container-fluid">
                <div class="row">
                  ...
                  <td>
                      {{$pendingPost->employer->email}}
                  </td>
                  <td>
                      {{$pendingPost->jobPosition}}
                  </td>
                                      <td>
                                          {{$pendingPost->employmentStatus}}
                                      </td>
                                      ...
                                      <td>
                                       ...
                                       <td>
                                          {{$pendingPost->responsibility}}
                                      </td>


{{--                <td>--}}
{{--                    <form action="{{ route('admin.post.update',$pendingPost->id) }}" method="post" >--}}
{{--                        @csrf--}}
{{--                        @method('put')--}}
...
{{--                </td>--}}
              <td>
                  <form action="{{ route('admin.post.delete',$pendingPost->id) }}" method="post" >
                      @csrf
                      @method('delete')
