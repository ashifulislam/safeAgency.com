                ...
                <div class="col-lg-12">
                    <div class="card">
                            <div class="edit-desc" style="display: none;">
                                ...
                                <div class="text-center"><a href="#!" class="btn btn-primary waves-effect waves-light m-r-20 m-t-20">Save</a> <a href="#!" id="edit-cancel-btn" class="btn btn-default waves-effect m-t-20">Cancel</a></div></div></div></div></div></div></div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="card b-l-success business-info services m-b-20">
                            ...
                            <div class="card-block">
                                <div class="row">
                                    <div class="col-sm-12">
                                        <p class="task-detail">{{$singleService->service_description}}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
