                            ...
                            <div class="col-lg-12">
                                <div class="cover-profile">
                                    <div class="profile-bg-img">
                                        ...
                                        <img class="profile-bg-img img-fluid" src="{{asset('local_agent\files\assets\images\user-profile\bg-img1.jpg')}}" alt="bg-img">
                                        <div class="card-block user-info">
                                            <div class="col-md-12">
                                                <div class="media-left">
                                                    <a href="#" class="profile-image">
                                                        <img src="{{asset('/img/profile/'.$singleAgent->photo)}}"  height="150px" width="100px"  class="img"  alt="user-img">
                                                    </a>
                                                </div>
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="tab-header card">
                                    <ul class="nav nav-tabs md-tabs tab-timeline" role="tablist" id="mytab">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" data-toggle="tab" href="#binfo" role="tab">Candidate's Services</a>
                                            <div class="slide"></div>
                                        </li>
{{--                                        <li class="nav-item">--}}
                                                                        ...
                                                                        <div class="table-responsive">
                                                                            <table class="table m-0">
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td>{{$singleAgent->name}}</td>
                                                                                </tr>
                                                                                <tr   >
                                                                                    <th scope="row">Skill</th>
                                                                                    <td>{{$singleAgent->skill}}</td>
                                                                                </tr>
                                                                                <tr>
                                                                        ...
                                                                        <div class="table-responsive">
                                                                            <table class="table">
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td>{{$singleAgent->email}}</td>
                                                                                </tr>
                                                                                <tr >
                                                                                    <th scope="row">Mobile Number</th>
                                                                                    <td>{{$singleAgent->phone}}</td>
                                                                                </tr>
                                                                                <tr>
                                                    ...
                                                    <div class="col-md-6">
                                                        @foreach($candidate_details as $candidate_detail)
                                                            ...
                                                            <div class="card b-l-success business-info services m-b-20">
                                                                <div class="card-header">
                                                                    <div class="service-header"><a href="#"><h5 class="card-header-text">Email: {{$candidate_detail->email}}</h5></a></div> <span data-toggle="dropdown" aria-haspopup="true" aria-expanded="true" role="tooltip" class="dropdown-toggle addon-btn text-muted f-right service-btn"></span>
                                                                ...
                                                                <div class="card-block">
                                                                    <div class="row">
                                                                        <div class="col-sm-12">
                                                                            ...
                                                                            <p class="task-detail">Age: {{$candidate_detail->age}}</p>
                                                                        </div>
                                                                        <div class="col-sm-12">

                                                                            <p class="task-detail">Nationality: {{$candidate_detail->nationality}}</p>
                                                                        </div>
                                                                        <div class="col-sm-12">

                                                                            <p class="task-detail">Company Name: {{$candidate_detail->company_name}}</p>
                                                                        </div>
                                                                        <div class="col-sm-12">

                                                                            <p class="task-detail">Company Country: {{$candidate_detail->company_country}}</p>
                                                                        </div>
                                                                        <div class="col-sm-12">

                                                                            <p class="task-detail">Service: completed</p>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                            ...
                                            <div class="col-xl-3">
                                                ...
                                                <div class="card">
                                                    <div class="card-header contact-user">
                                                        <img class="img-radius img-40" src="{{asset('local_agent\files\assets\images\avatar-4.jpg')}}" alt="contact-user">
                                                ...
                                                <div class="card">
                                                    ...
                                                    <div class="card-block">
                                                        <div class="connection-list">
                                                            <a href="#"><img class="img-fluid img-radius" src="{{asset('local_agent\files\assets\images\user-profile\follower\f-1.jpg')}}" alt="f-1" data-toggle="tooltip" data-placement="top" data-original-title="Airi Satou">
                                                            </a>
                                                            <a href="#"><img class="img-fluid img-radius" src="{{asset('local_agent\files\assets\images\user-profile\follower\f-2.jpg')}}" alt="f-2" data-toggle="tooltip" data-placement="top" data-original-title="Angelica Ramos">
                                                            </a>
                                                            <a href="#"><img class="img-fluid img-radius" src="{{asset('local_agent\files\assets\images\user-profile\follower\f-3.jpg')}}" alt="f-3" data-toggle="tooltip" data-placement="top" data-original-title="Ashton Cox">
                                                            </a>
                                                            <a href="#"><img class="img-fluid img-radius" src="{{asset('local_agent\files\assets\images\user-profile\follower\f-4.jpg')}}" alt="f-4" data-toggle="tooltip" data-placement="top" data-original-title="Cara Stevens">
                                                            </a>
                                                            <a href="#"><img class="img-fluid img-radius" src="{{asset('local_agent\files\assets\images\user-profile\follower\f-5.jpg')}}" alt="f-5" data-toggle="tooltip" data-placement="top" data-original-title="Garrett Winters">
                                                            </a>
                                                            <a href="#"><img class="img-fluid img-radius" src="{{asset('local_agent\files\assets\images\user-profile\follower\f-1.jpg')}}" alt="f-6" data-toggle="tooltip" data-placement="top" data-original-title="Cedric Kelly">
                                                            </a>
                                                            <a href="#"><img class="img-fluid img-radius" src="{{asset('local_agent\files\assets\images\user-profile\follower\f-3.jpg')}}" alt="f-7" data-toggle="tooltip" data-placement="top" data-original-title="Brielle Williamson">
                                                            </a>
                                                            <a href="#"><img class="img-fluid img-radius" src="{{asset('local_agent\files\assets\images\user-profile\follower\f-5.jpg')}}" alt="f-8" data-toggle="tooltip" data-placement="top" data-original-title="Jena Gaines">
                                                            </a>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="card-block">
                                                <ul class="media-list">
                                                    <li class="media">
                                                        <div class="media-left">
                                                            <a href="#">
                                                                <img class="media-object img-radius comment-img" src="{{asset('local_agent\files\assets\images\avatar-1.jpg')}}" alt="Generic placeholder image">
                                                            </a>
                                                        </div>
                                                        <div class="media-body">
                                                            ...
                                                            <div class="media mt-2">
                                                                <a class="media-left" href="#">
                                                                    <img class="media-object img-radius comment-img" src="{{asset('local_agent\files\assets\images\avatar-2.jpg')}}" alt="Generic placeholder image">
                                                                </a>
                                                                <div class="media-body">
                                                                    ...
                                                                    <div class="media mt-2">
                                                                        <div class="media-left">
                                                                            <a href="#">
                                                                                <img class="media-object img-radius comment-img" src="{{asset('local_agent\files\assets\images\avatar-3.jpg')}}" alt="Generic placeholder image">
                                                                            </a>
                                                                        </div>
                                                                        <div class="media-body">
                                                            ...
                                                            <div class="media mt-2">
                                                                <a class="media-left" href="#">
                                                                    <img class="media-object img-radius comment-img" src="{{asset('local_agent\files\assets\images\avatar-4.jpg')}}" alt="Generic placeholder image">
                                                                </a>
                                                                <div class="media-body">
                                                                    <h6 class="media-heading">Larry heading <span class="f-12 text-muted m-l-5">Just now</span></h6>
                                                                    <div class="stars-example-css review-star">
            ...
            <div class="modal-dialog modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5  class="modal-title" id="addNewLabel">Update Your Profile</h5>
