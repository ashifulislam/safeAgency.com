    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-12">
                ...
                <form method="POST" class="md-float-material form-material" action="{{ route('localAgent.login.submit') }}">
                @csrf
                    <div class="auth-box card">
                        <div class="card-block">
                            ...
                            <div class="form-group form-primary">
                                <input id="email" type="email" class="form-control @error('email') is-invalid @enderror" name="email" placeholder="Enter Your Email Address">
                                @error('email')
                            ...
                            <div class="form-group form-primary">
                                <input id="password" type="password" class="form-control @error('password') is-invalid @enderror" name="password" placeholder="Enter Your Password Here">
...
{{--                            </div>--}}
                            <div class="row m-t-30">
                               ...
                               Not Registered? <a href="{{route('localAgent.register')}}" class="btn btn-primary">SIGNUP</a>
                        </div>
                    </div>
                </form>
                <!-- end of form -->
