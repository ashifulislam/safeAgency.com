...
<head>
    ...
    <!-- morrisjs CSS
		============================================ -->
    <link rel="stylesheet" href="{{asset('adminPanel')}}/css/morris{{asset('adminPanel')}}/js/morris.css">
    <!-- mCustomScrollbar CSS
		============================================ -->
    <link rel="stylesheet" href="{{asset('adminPanel')}}/css/scrollbar/jquery.mCustomScrollbar.min.css">
    <!-- metisMenu CSS
		============================================ -->
    <link rel="stylesheet" href="{{asset('adminPanel')}}/css/metisMenu/metisMenu.min.css">
