                    ...
                    <div class="row align-items-end">
                        <div class="col-lg-8">
                            <div class="page-header-title">
                                <div class="d-inline">
                                    <h4>Employer List</h4>
                                    <span>Here are all the employers</span>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <div id="simpletable_wrapper" class="dataTables_wrapper dt-bootstrap4">
                                            ...
                                            <div class="row"><div class="col-xs-12 col-sm-12">
                                                    <table id="simpletable" class="table table-striped table-bordered nowrap dataTable" role="grid" aria-describedby="simpletable_info">
                                                        <thead>
                                                        <tr role="row"><th class="sorting_asc" tabindex="0" aria-controls="simpletable" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Name: activate to sort column descending" style="width: 201px;">Name</th><th class="sorting" tabindex="0" aria-controls="simpletable" rowspan="1" colspan="1" aria-label="Position: activate to sort column ascending" style="width: 299px;">Email</th><th class="sorting" tabindex="0" aria-controls="simpletable" rowspan="1" colspan="1" aria-label="Office: activate to sort column ascending" style="width: 147px;">Company</th><th class="sorting" tabindex="0" aria-controls="simpletable" rowspan="1" colspan="1" aria-label="Age: activate to sort column ascending" style="width: 74px;">Country</th>
                                                            <th class="sorting" tabindex="0" aria-controls="simpletable" rowspan="1" colspan="1" aria-label="Start date: activate to sort column ascending" style="width: 149px;">Zip Code</th>
                                                            <th class="sorting" tabindex="0" aria-controls="simpletable" rowspan="1" colspan="1" aria-label="Salary: activate to sort column ascending" style="width: 105px;">Send Request</th></tr>
                                                        </thead>
                                                        <tbody>
                                                        ...
                                                        @foreach($employer as $singleEmployer)
                                                        <tr role="row" class="odd">
                                                            <td class="sorting_1">{{$singleEmployer->firstName}}</td>
                                                            <td>{{$singleEmployer->email}}</td>
                                                            <td>{{$singleEmployer->companyName}}</td>
                                                            <td>{{$singleEmployer->companyCountry}}</td>
                                                            <td>{{$singleEmployer->companyZipCode}}</td>
                                                            <td>
                                                                <form action="{{route('sendRequest', [$singleEmployer->id])}}" method="post">
                                                                    @csrf
                                                                    <input name="status" type="hidden" value="pending">

                                                                    <button style="width:128px;" class="btn btn-primary">Send Request</button>
