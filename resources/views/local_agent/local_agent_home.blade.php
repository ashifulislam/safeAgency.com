                            ...
                            <div class="card-block">
                                <div class="row m-b-25">
                                    <div class="col-auto p-r-0">
                                        <div class="u-img">
                                            <img src="{{asset('local_agent\files\assets\images\breadcrumb-bg.jpg')}}" alt="user image" class="img-radius cover-img">
                                            <img src="{{asset('local_agent\files\assets\images\avatar-2.jpg')}}" alt="user image" class="img-radius profile-img">
                                        </div>
                                    </div>
                                    <div class="col">
                                                    ...
                                                    <tr>
                                                        <td class="b-none">
                                                            <a href="#!" class="align-middle">
                                                                <img src="{{asset('local_agent\files\assets\images\avatar-2.jpg')}}" alt="user image" class="img-radius img-40 align-top m-r-15">
