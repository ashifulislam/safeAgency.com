...
class SslCommerzPaymentController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $post_data = array();
        $post_data['total_amount'] = $request->input('demands'); # You cant not pay less than 10
        ...
        $post_data['cus_add1'] = $request->input('first_address');
        $post_data['cus_add2'] = "";
    ...
    public function payViaAjax(Request $request)
    {
       ...
       dd($customer_info = json_decode($data,1));
        ...
        # CUSTOMER INFORMATION
        $post_data['cus_name'] = $customer_info['cus_name'];
        $post_data['cus_email'] = $customer_info['cus_email'];
        $post_data['cus_add1'] = $customer_info['cus_addr1'];
        $post_data['cus_add2'] = "";
        $post_data['cus_city'] = "";
        $post_data['cus_state'] = "";
        $post_data['cus_postcode'] = "";
        $post_data['cus_country'] = "Bangladesh";
        $post_data['cus_phone'] = $customer_info['cus_phone'];
        $post_data['cus_fax'] = "";
